...
import {
  LayoutDashboard, Building2, Users, Factory, ListChecks, ClipboardList, LogOut, ShieldCheck,
  ScrollText, Settings,
} from "lucide-react";
import {
...
const items = [
  ...
  { title: "Establishments", url: "/admin/establishments", icon: Factory },
        ...
        <div className="flex items-center gap-2 px-2 py-2">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <div className="truncate text-[10px] text-sidebar-foreground/60">Admin Console</div>
            </div>
          )}
        </div>
      </SidebarHeader>
