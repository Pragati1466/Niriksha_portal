  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <a href="/" className="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">Go home</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Agentic AI-powered regulatory inspection platform for government departments." },
      { property: "og:title", content: "NIRIKSHA — Government Inspection Intelligence" },
      { property: "og:description", content: "Modernize government inspections with structured data and AI-assisted decision support." },
